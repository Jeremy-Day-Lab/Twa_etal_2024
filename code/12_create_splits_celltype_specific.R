...
## testing
Rn7_VTA.testing <- readRDS("/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/2_create_splits/Rn7_VTA_testing.RDS")
## previous DEG results
Sex_DEGs <- read.csv("/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/3_feature_selection_DEGs/DEGs_sex_cluster_VTA_sig.csv")
...
# save outputs ####
## seurat objects
saveRDS(Rn7_VTA.training.neuronal, "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/12_create_splits_celltype_specific/Rn7_VTA_training_neuronal.RDS")
saveRDS(Rn7_VTA.training.nonneuronal, "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/12_create_splits_celltype_specific/Rn7_VTA_training_nonneuronal.RDS")

saveRDS(Rn7_VTA.testing.neuronal, "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/12_create_splits_celltype_specific/Rn7_VTA_testing_neuronal.RDS")
saveRDS(Rn7_VTA.testing.nonneuronal, "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/12_create_splits_celltype_specific/Rn7_VTA_testing_nonneuronal.RDS")

## count data subsets
saveRDS(training.neuronal.count_data_subset, "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/12_create_splits_celltype_specific/training_neuronal_count_subset.RDS")
saveRDS(training.nonneuronal.count_data_subset, "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/12_create_splits_celltype_specific/training_nonneuronal_count_subset.RDS")
