...
## Data ####
Rn7_VTA <- readRDS("/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/Rn7_Xist_VTA.RDS")
...
# Save outputs ####
## save summary table
write.csv(summary.df, file = "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/2_create_splits/CellType_Sex_split_summary.csv")

## save cell split vectors
saveRDS(training_cells, file = "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/2_create_splits/traincell_vector.RDS")
saveRDS(testing_cells, file = "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/2_create_splits/testcell_vector.RDS")

## save Rn7 training and testing objects 
saveRDS(Rn7_VTA_training, file = "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/2_create_splits/Rn7_VTA_training.RDS")
saveRDS(Rn7_VTA_testing, file = "/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/2_create_splits/Rn7_VTA_testing.RDS")
