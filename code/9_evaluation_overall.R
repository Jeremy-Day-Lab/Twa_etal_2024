...
g <- ggroc(data = list(`Chr Y` = chrY_roc,
  ...
  labs(color = "Model") +
  theme_bw()
ggsave(filename = "/data/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/plots/9_evaluation_overall/ROC_curves.pdf",
...
rownames(auc.table) <- c("Chr Y",
                         ...
                         "Random Forest",
                         "MLP")
write.csv(auc.table, "/data/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/9_evaluation_overall/AUCs_table.csv")
...
rownames(acc.table) <- c("Chr Y",
                         ...
                         "Random Forest",
                         "MLP")
write.csv(acc.table, "/data/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/processed_data/9_evaluation_overall/Accuracy_table.csv")
...
ggsave(plot = confusion.plot,
       file = "/data/scratch/gtwa/Day/sex_prediction_model/Rn7_Xist_add/plots/9_evaluation_overall/confusionplot.pdf",
       height = 7,
       width = 10,
       device = "pdf")
