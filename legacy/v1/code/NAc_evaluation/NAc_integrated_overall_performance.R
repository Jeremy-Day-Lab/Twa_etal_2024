...
g <- ggroc(data = list(`Chr Y` = chrY_roc,
  ...
  labs(color = "Model") +
  theme_bw()
ggsave(filename = "/scratch/gtwa/Day/sex_prediction_model/output/NAc_evaluation/ROC_curves.pdf",
...
write.csv(auc.table, "/scratch/gtwa/Day/sex_prediction_model/output/NAc_evaluation/AUCs_table.csv")
...
write.csv(acc.table, "/scratch/gtwa/Day/sex_prediction_model/output/NAc_evaluation/Accuracy_table.csv")
...
ggsave(plot = confusion.plot,
       file = "/scratch/gtwa/Day/sex_prediction_model/output/NAc_evaluation/confusionplot.pdf",
       height = 7,
       width = 10,
       device = "pdf")
