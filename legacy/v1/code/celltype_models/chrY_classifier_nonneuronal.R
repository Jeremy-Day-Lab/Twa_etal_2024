...
ggsave(plot = overall.distb,
       filename = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Ydistb.training.nonneuronal.all.pdf",
       height = 5,
       width = 5)

ggsave(plot = wrap.distb,
       filename = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Ydistb.training.nonneuronal.split.pdf",
       height = 5,
       width = 10)
...
#### write out
write.csv(stats.df, file = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Ydistb.training.nonneuronal.sumstats.csv")
...
roc.plot <- ggroc(data = simple.roc) +
  ...
  theme_bw()
ggsave(filename = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Ydistb.training.nonneuronal.roc.pdf",
       plot = roc.plot,
       height = 5,
       width = 5)
...
write.csv(testing.predictions, file = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Yclass.predictions.nonneuronal.csv")
