...
## load data
### training data frame
training <- read.csv("/scratch/gtwa/Day/sex_prediction_model/data/celltype_models/training_count_data_nonneuronal.csv", row.names = 1)
...
stopCluster(cl)
# Write out files ####
saveRDS(svm_model, file = "/scratch/gtwa/Day/sex_prediction_model/data/celltype_models/models/svm_rad_model_nonneuronal.RDS")
