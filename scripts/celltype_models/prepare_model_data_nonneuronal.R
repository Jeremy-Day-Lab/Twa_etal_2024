...
## load data
### Boruta object
VTA_Boruta_max2000 <- readRDS("/scratch/gtwa/Day/sex_prediction_model/data/celltype_models/VTA_Boruta_max2000_nonneuronal.RDS")
### training data
Rn7_VTA_training <- readRDS("/scratch/gtwa/Day/sex_prediction_model/data/celltype_models/Rn7_VTA_training_nonneuronal.RDS")
### training data count matrix of sex DEGs
training_count_data_sex <- readRDS("/scratch/gtwa/Day/sex_prediction_model/data/celltype_models/training_nonneuronal_count_subset.RDS")
### testing data
Rn7_VTA_testing <- readRDS("/scratch/gtwa/Day/sex_prediction_model/data/celltype_models/Rn7_VTA_testing_nonneuronal.RDS")
...
write.csv(VTA_Boruta_decision, file = "/scratch/gtwa/Day/sex_prediction_model/data/celltype_models/Boruta_final_decisions_nonneuronal.csv", row.names = F)
## training and testing count data frames
write.csv(training_count_data_sex_important, file = "/scratch/gtwa/Day/sex_prediction_model/data/celltype_models/training_count_data_nonneuronal.csv")
write.csv(test_count_data_sex_important, file = "/scratch/gtwa/Day/sex_prediction_model/data/celltype_models/test_count_data_nonneuronal.csv")
