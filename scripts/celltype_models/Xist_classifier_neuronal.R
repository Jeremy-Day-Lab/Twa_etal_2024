...
ggsave(plot = overall.distb,
       filename = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Xist.distb.training.neuronal.all.pdf",
       height = 5,
       width = 5)

ggsave(plot = wrap.distb,
       filename = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Xist.distb.training.neuronal.split.pdf",
       height = 5,
       width = 10)
...
#### write out
write.csv(stats.df, file = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Xist.distb.training.neuronal.sumstats.csv")
...
roc.plot <- 
  ...
  theme_bw()
ggsave(filename = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Xist.training.neuronal.roc.pdf",
       plot = roc.plot,
       height = 5,
       width = 5)
...
write.csv(testing.predictions, file = "/scratch/gtwa/Day/sex_prediction_model/output/celltype_models/Xist.class.predictions.neuronal.csv")
